            ...
            foreach (var size in Size.All)
            {
                ...
                var expectedSizeCount = shirts
                    .Count(shirt => shirt.Size.Id == size.Id
                                ...
                                && (!searchOptions.Sizes.Any() || searchOptions.Sizes.Any(s => s.Id == size.Id))
                                );
            ...
            foreach (var color in Color.All)
            {
                ...
                var expectedColorCount = shirts
                    .Count(shirt => shirt.Color.Id == color.Id
                                && (!searchOptions.Colors.Any() || searchOptions.Colors.Any(c => c.Id == color.Id))
                                && (!searchOptions.Sizes.Any() || searchOptions.Sizes.Any(s => s.Id == shirt.Size.Id)));
